---
description: "Create a draft pull request. Same as /raise-pr --draft."
argument-hint: "[]"
allowed-tools: "Bash"
model: "sonnet"
---
...
Create a draft pull request for the current branch. Identical to `/raise-pr --draft`.
...
Output the URL of the newly created draft PR.
